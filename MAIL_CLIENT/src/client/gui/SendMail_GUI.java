...
public class SendMail_GUI extends JFrame {
		...
		Thread t = new Thread() {
			public void run() {
				try {
					...
					sendmail.connect("127.0.0.1", 25);
					if (sendmail.command(Main_GUI.getUSER_EMAIL(), tf_mailTo.getText().trim(),
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SendMail_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);

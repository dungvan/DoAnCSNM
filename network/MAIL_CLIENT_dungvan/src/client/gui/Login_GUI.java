...
public class Login_GUI extends JFrame {
	...
	private void initComponents() {
		...
		bt_login.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/image/login/login.png")));
		...
		background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/image/login/mangcau.png"))); // NOI18N
	...
	private void bt_loginActionPerformed(ActionEvent evt) {
		 ...
		 */
		try {
			Socket socket = new Socket(ConnectionServerOption.SERVER_NAME, ConnectionServerOption.SERVER_AUTH_PORT);
			...
			if (conn.receive().equals("true")) {
				 ...
				 */
				Client_GUI.setUSER_EMAIL(tf_email.getText() + "@custardapple.com");
				Client_GUI.setPASS_EMAIL(passField.getText());
